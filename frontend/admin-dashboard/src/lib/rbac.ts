...
export const MANAGEABLE_TABS: ManageableTab[] = [
  ...
  { key: "crm:customers", label: "Customers (hub)", group: "CRM", roles: ["Sales", "Sales_Head", "TA"] },
  { key: "crm:rate-cards", label: "CTC Slab (customer branch)", group: "CRM", roles: ["Sales", "Sales_Head"] },
  ...
  { key: "crm:timesheets", label: "Timesheets (in Projects hub)", group: "CRM",
    roles: ["HR", "Finance", "RMG", "Sales", "Sales_Head", "TA"] },
  { key: "crm:my-leave", label: "My Leave (in Timesheets)", group: "CRM",
    roles: ["Sales", "Sales_Head", "RMG", "TA", "HR", "Finance"] },
  { key: "crm:leave-applications", label: "Leave Applications (in Timesheets)", group: "CRM", roles: ["HR"] },
  { key: "crm:holidays", label: "Holidays (also in Customer hub)", group: "CRM", roles: ["HR"] },
  { key: "crm:branch-policy", label: "Branch Policy", group: "CRM", roles: ["Sales", "Sales_Head", "HR"] },
  { key: "crm:pos", label: "Purchase Orders (in hubs)", group: "CRM", roles: ["Finance", "Sales", "Sales_Head"] },
  { key: "crm:invoices", label: "Invoices (in hubs)", group: "CRM", roles: ["Finance", "Sales", "Sales_Head"] },
